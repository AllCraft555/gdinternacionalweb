...
function getUserData(user) {
    ...
    Swal.fire({
        ...
        html : '<center><strong>Puntos : '+user_data[user].point + '<br>'+
            'Nivel Mas Dificil : '+user_data[user].highest+'<br>'+
            'Niveles Completados : '+clears+' Nivel(es)<br>'+
            '<br>Registro De Niveles : '+progresses+'<br>'+
            '</strong></center>'
    });
